...
namespace model482f92c1429cc_cdm_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model482f92c1429cc_cdm");
    reader.add_event(69, 67, "end", "model482f92c1429cc_cdm");
    return reader;
}

class model482f92c1429cc_cdm
  : public stan::model::model_base_crtp<model482f92c1429cc_cdm> {
private:
        int Nz;
        int Nq;
        int Nskill;
...
public:
    model482f92c1429cc_cdm(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model482f92c1429cc_cdm_namespace::model482f92c1429cc_cdm";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model482f92c1429cc_cdm_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model482f92c1429cc_cdm_namespace::model482f92c1429cc_cdm stan_model;
